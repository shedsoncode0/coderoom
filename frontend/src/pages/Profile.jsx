        ...
        <div className='w-full'> 
            ...
            <div className='w-full bg-white'>
                ...
                <div className='w-full flex flex-col items-center space-y-2 relative'>
                    ...
                    <p className='py-1 text-lg font-medium text-TextColor'>Developer</p>
                    <div className='p-3 border-[2px] border-Stroke flex space-x-3 rounded-md'>
                        ...
                        <h1 className='border-l-[2px] border-r-[2px] border-Stroke px-2 text-Dark text-xl font-medium'>259k <span className='text-TextColor text-lg font-normal'>Followers</span></h1>
                        <h1 className='px-2 text-Dark text-xl font-medium'>2k <span className='text-TextColor text-lg font-normal'>Following</span></h1>
                    </div>
                </div>
